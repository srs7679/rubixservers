package com.rubix.farmersmarket.util;
...
// ----------------- Fix for LANG-440 ---------------------- END ---------------
	...
	/**
	 * <p>
	 * Constructs an Iterator over each day in a date range defined by a focus date
	 * and range style.
	 * </p>
	 *
	 * <p>
	 * For instance, passing Thursday, July 4, 2002 and a <code>RANGE_MONTH_SUNDAY
	 * will return an Iterator that starts with Sunday, June 30, 2002 and ends with
	 * Saturday, August 3, 2002, returning a Calendar instance for each intermediate
	 * day.
	 * </p>
	 *
	 * <p>
	 ...
	 * @throws IllegalArgumentException if the date is <code>null or fragment is not
	 *                                  supported
	 * @since 2.4
	 */
	 ...
	 * @return <code>true if equal; otherwise false
